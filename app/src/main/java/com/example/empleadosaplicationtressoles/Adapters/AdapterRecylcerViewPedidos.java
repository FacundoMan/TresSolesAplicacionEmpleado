...
public class AdapterRecylcerViewPedidos extends RecyclerView.Adapter<AdapterRecylcerViewPedidos.ViewHolder> {
    private List<Pedido> pedidosDatos;
    private LayoutInflater mInflater;
    private Context context;
    final AdapterRecylcerViewPedidos.OnItemClickListener listener;
    //Se agrega para poder hacer click en el reclicler view
    public interface OnItemClickListener{
        void onItemClick(Pedido item);
    }

    public AdapterRecylcerViewPedidos(List<Pedido> itemList, Context context,AdapterRecylcerViewPedidos.OnItemClickListener listener){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parents, int viewType){
        View view=LayoutInflater.from(parents.getContext()).inflate(R.layout.activity_elemento_pedidos,null);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ViewHolder(View itemView){
            super(itemView);
            nombre=itemView.findViewById(R.id.tvNombrePedidoElemento);
            fecha=itemView.findViewById(R.id.tvFechaPedidoElemento);
            estado=itemView.findViewById(R.id.tvEstadoPedidoElemento);
        }
